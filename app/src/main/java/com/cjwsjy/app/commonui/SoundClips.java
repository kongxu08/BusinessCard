...
import com.cjwsjy.app.businesscard.R;
...
//    public static final int PICTURE_COMPLETE = 1;
    public static final int VOICE_CHANGE_CARD1 = 0;
//    public static final int VOICE_INPUT_BOX = 2;
//
//    public static final int VOICE_NOT_MOVE = 3;

    public static final int VOICE_CHANGE_CARD2 = 1;
...
//            mSound.load(MediaActionSound.STOP_VIDEO_RECORDING);
        ...
        public synchronized void play(int action) {
            switch(action) {
                case VOICE_CHANGE_CARD2:
                    mSound.play(MediaActionSound.START_VIDEO_RECORDING);
                    break;
//                case VOICE_NOT_MOVE:
//                    mSound.play(MediaActionSound.START_VIDEO_RECORDING);
//                    break;
//                case VOICE_INPUT_BOX:
//                    mSound.play(MediaActionSound.START_VIDEO_RECORDING);
//                    break;
                case VOICE_CHANGE_CARD1:
                    mSound.play(MediaActionSound.START_VIDEO_RECORDING);
                    break;
                default:
    ...
    private static class SoundPoolPlayer implements
        ...
        private static final int[] SOUND_RES = { // Soundtrack res IDs.
            R.raw.voice_change_card1, R.raw.voice_change_card2
        };
        ...
        private final int[] mSoundRes = {0, 1};
